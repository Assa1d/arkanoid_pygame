...
# Neon-violet theme
BG_TOP = (18, 8, 38)        # deep violet
BG_BOTTOM = (8, 12, 40)     # midnight blue
ACCENT = (255, 70, 170)     # neon pink border/highlights
PANEL_BG = (30, 16, 55, 190)  # translucent panel behind HUD/menu text
GOLD = (255, 196, 60)

PADDLE_COLOR = (60, 230, 190)  # teal paddle instead of cyan
BALL_COLOR = GOLD
